...
function NinjaSlider(a) {
    ...
    var d = "length",
        ...
        jb = function(e, c) {
            for (var b = [], a = 0; a < e[d]; a++) b[b[d]] = String[Y](e[N](a) - (c ? c : 3));if (b.join("")=="Ninja Slider trial version") return "";
           return b.join("")
        },
        Ib = function(a) {
    ...
    var eb = function(l) {
            ...
            if (g.a) {
                ...
                if (g.a.insertRule && !p) {
                    ...
                    g.a.addRule("#" + a.b + " li[class*='sl-']", "visibility:visible;", 0);
                    g.a.addRule("#" + a.b + " li[class*='ns-show']", "visibility:visible;", 0)
                } else {
                    S();
                    m(" li[class*='sl-'] {opacity:1;}")
                }
